...
$classes = ($active ?? false)
            ? 'block w-full border-l-4 border-accent bg-accent-100 py-3 ps-3 pe-4 text-start text-sm font-semibold uppercase tracking-label text-accent-800 transition focus:outline-none'
